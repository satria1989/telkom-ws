...
public class LogHistoryDao {
    ...
    public void insertToLogHistory(LogHistory lh) throws Exception {
...
//      ps.setString(1, lh.getCreatedBy()); // createdBy
//      ps.setString(2, lh.getCreatedBy()); // createdByName
...
//    }
    ...
    public void insertToLogHistorytemporary(LogHistory lh) throws Exception {
//        PreparedStatement ps = null;
//        boolean result = false;
//        StringBuilder query = new StringBuilder();
//        Connection con = gc.getJogetConnection();
...
//                        .append(" INSERT INTO app_fd_log_history_wa_api@TICKETING_DB1 ")
        ...
        try {
            ...
            ps.setInt(14, lh.getResponseCode());
            ps.executeUpdate();
        } catch (Exception ex) {
            logInfo.Log(getClass().getName(), ex.getMessage());
        } finally {
